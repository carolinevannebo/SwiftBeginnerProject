...
struct PhoneNumberView: View {
    ...
    var body: some View {
        //GeometryReader { geo in
            ...
            NavigationStack {
                //VStack {
                    //Text("Confirm country code and enter phone number").multilineTextAlignment(.center).font(.title).bold().padding(.top, hasHomeIndicator ? 70 : 20)
                    HStack {
...
struct PhoneNumberView_Previews: PreviewProvider {
    static var previews: some View {
        PhoneNumberView(countryCode: "+47", countryFlag: "🇳🇴", countryPattern: "### ## ###", countryLimit: 17)
    }
}
